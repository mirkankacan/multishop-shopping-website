...
namespace MultiShop.WebUI.Services.Concrete
{
    public class ClientCredentialTokenService : IClientCredentialTokenService
    {
        ...
        {
            var currentToken = await _clientAccessTokenCache.GetAsync("multishoptoken", new ClientAccessTokenParameters(), cancellationToken);
            ...
            await _clientAccessTokenCache.SetAsync("multishoptoken", newToken.AccessToken, newToken.ExpiresIn, new ClientAccessTokenParameters(), cancellationToken);
